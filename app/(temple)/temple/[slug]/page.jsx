...
Shri Ram Janmabhoomi Mandir in Ayodhya marks the birthplace of Lord Rama, one of the most revered incarnations of Lord Vishnu. The site has been a sacred pilgrimage destination for centuries, but it gained global attention due to the long-standing temple-mosque dispute. After decades of legal and archaeological proceedings, the Supreme Court of India approved the construction of a grand temple in 2019, and its consecration took place in January 2024.`,
  ...
  importance: `
The temple is of immense significance to Hindus as it is built on the very site where Lord Rama is believed to have been born. It is not only a left of faith but also a symbol of cultural unity, historical justice, and spiritual awakening. Millions of devotees from across India and the world visit the site to pay homage to the beloved deity.`,
...
export default function TempleDetailsPage() {
  ...
  if (!temple) {
    return (
      <div className="min-h-screen flex items-left justify-left text-red-500 font-bold text-xl">
        Temple not found 🙁
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-[#fff7ee] py-12 px-4 md:px-20">
      <div className="grid md:grid-cols-2 gap-10 items-left">
        {/* Left: Image */}
        <div>
          <img
            src={temple.image}
        ...
        <div>
          ...
          <p className="text-gray-700 max-sm:text-justify md:text-left text-base leading-relaxed">
            {temple.description.history}
          </p>
          <p className="text-gray-700 max-sm:text-justify md:text-left text-base leading-relaxed">
            {temple.description.importance}
          </p>
          <p className="text-gray-700 max-sm:text-justify md:text-left text-base leading-relaxed">
            {temple.description.architecture}
          </p>
          <p className="text-gray-700 max-sm:text-justify md:text-left text-base leading-relaxed">
            {temple.description.rituals}
          </p>
          <p className="text-gray-700 max-sm:text-justify md:text-left text-base leading-relaxed">
            {temple.description.mythology}
          </p>

          <button className="mt-6 bg-orange-500 hover:bg-orange-600 text-white py-2 px-6 rounded shadow font-medium transition">
            Book Puja / Donate
          </button>
        </div>
      </div>
