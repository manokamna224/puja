...
export default function Footer() {
  return (
    <footer className="bg-[#FFF8F0] text-[#FF6A00] py-12 px-4 sm:px-8 md:px-16 lg:px-24">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
        {/* Logo Section */}
        <div className="col-span-1">
          <h2 className={`text-[#FF6A00] text-2xl font-bold mb-1 ${PlayfairDisplay.className}`}>
            PUJA NIVARAN
          </h2>
          <p className="text-xs font-mono text-[#FF6A00]">
        ...
        {/* Links */}
        <div>
          <h4 className="text-md font-semibold text-[#FF6A00] mb-2">Links</h4>
        ...
        {/* Help */}
        <div>
          <h4 className="text-md font-semibold text-[#FF6A00] mb-2">Help</h4>
          <ul className="space-y-1 text-sm">
        ...
        {/* Documents */}
        <div>
          <h4 className="text-md font-semibold text-[#FF6A00] mb-2">Documents</h4>
          <ul className="space-y-1 text-sm">
        ...
        {/* Social */}
        <div>
          <h4 className="text-md font-semibold text-[#FF6A00] mb-2">Get in touch</h4>
          <p className="text-sm text-[#FF6A00] mb-4">
      ...
      {/* Bottom Note */}
      <div className="text-center text-xs text-[#FF6A00] mt-10 border-t border-gray-800 pt-6">
