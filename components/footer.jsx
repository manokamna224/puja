...
export default function Footer() {
  return (
    <footer className="bg-[#030216] text-gray-400 py-12 px-4 sm:px-8 md:px-16 lg:px-24">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10">
        ...
        {/* Help */}
        <div>
          <h4 className="text-md font-semibold text-gray-300 mb-2">Help</h4>
          <ul className="space-y-1 text-sm">
        ...
        {/* Documents */}
        <div>
          <h4 className="text-md font-semibold text-gray-300 mb-2">Documents</h4>
          <ul className="space-y-1 text-sm">
        ...
        {/* Social */}
        <div>
          <h4 className="text-md font-semibold text-gray-300 mb-2">Get in touch</h4>
